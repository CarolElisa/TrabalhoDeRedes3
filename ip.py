...
class IP:
    ...
    def __raw_recv(self, datagrama):
        ...
        if dst_addr == self.meu_endereco:
            ...
            #Modificar o datagrama (cabeçalho IP) antes de fazer o encaminhamento
            #Decrementar o TTL
            #Se o ttl == 0, descartar o segmento (não pode haver mais tentativas de envio)
            #self.meu_endereco = remetente
            ttl = ttl - 1
            proto = IPPROTO_TCP
            if (ttl == 0):
                proto = IPPROTO_ICMP  
    ...
    def enviar(self, segmento, dest_addr):
        ...
        vihl, dscpecn, total_len, identification, flagsfrag, ttl, proto, checksum, src_addr = 69, 0, 20+len(segmento), self.identificador, 0, 64, 6, 0, self.meu_endereco
